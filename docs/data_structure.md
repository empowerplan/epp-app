...
Der Bereich `digipipe` enthält die für die Anwendung aufbereiteten Daten in einer strukturierten Form. Diese Daten sind in mehrere Unterverzeichnisse organisiert:
