...
MAP_ENGINE_MIN_ZOOM = 15
MAP_ENGINE_MAX_ZOOM = 15
MAP_ENGINE_MAX_BOUNDS = [[12.6, 51.8], [16.1, 53.1]]

# distill
MAP_ENGINE_X_AT_MIN_Z = 17536
MAP_ENGINE_Y_AT_MIN_Z = 10624
MAP_ENGINE_X_OFFSET = 256  # Defines how many tiles to the right are added at first level
MAP_ENGINE_Y_OFFSET = 256  # Defines how many tiles to the bottom are added at first level
